    ...
    <>
      <div className="p-4">
        <form className="flex max-w-sm mx-auto">
          ...
          <button
            type="submit"
            className="w-max h-full inline-block px-5 py-8 bg-yellow-400 text-white leading-snug rounded shadow-md hover:bg-yellow-400 hover:shadow-lg focus:bg-yellow-400 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-yellow-400 "
